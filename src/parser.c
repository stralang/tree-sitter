...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [STATE(2)] = {
    [sym_expr] = STATE(26),
    [sym_literal_expr] = STATE(28),
    [sym_binary_expr] = STATE(28),
    [sym_unary_expr] = STATE(28),
    [sym_const_type] = STATE(28),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [29] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary_expr, 3, 0, 0),
  [31] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_binary_expr, 3, 0, 0),
  ...
  [51] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_primitive_type, 1, 0, 0),
  [53] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_primitive_type, 1, 0, 0),
  [55] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bool, 1, 0, 0),
  [57] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_bool, 1, 0, 0),
  [59] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_field, 3, 0, 2),
  ...
  [91] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_const_type, 3, 0, 0),
  [93] = {.entry = {.count = 1, .reusable = false}}, SHIFT(4),
  [95] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_field, 5, 0, 4),
  [97] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_field, 4, 0, 3),
